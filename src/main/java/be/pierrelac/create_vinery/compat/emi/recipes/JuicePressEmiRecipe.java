package be.pierrelac.create_vinery.compat.emi.recipes;
...
import be.pierrelac.create_vinery.compat.emi.CreateVineryEmiAnimations;
...
public class JuicePressEmiRecipe extends CreateEmiRecipe<JuicePressRecipe> {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        CreateVineryEmiAnimations.addJuicePress(widgets, 81, 40);
